			...
			{#snippet actions(row)}
				<div class="flex justify-end gap-[var(--space-1)]">
					...
					{#if authStore.isAdmin}
						...
						<button
							class="p-[var(--space-1)] text-[var(--color-text-secondary)] transition-colors hover:bg-[var(--color-surface)] hover:text-[var(--color-danger)] focus-visible:ring-2 focus-visible:ring-[var(--color-accent)] focus-visible:outline-none"
