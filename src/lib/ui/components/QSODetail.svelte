...
<div class="flex flex-col gap-[var(--space-8)]">
  ...
  <section>
    ...
    <dl class="grid grid-cols-1 md:grid-cols-2 gap-x-[var(--space-8)] gap-y-[var(--space-3)]">
      <div>
        <dt class="text-[var(--text-body)] text-[var(--color-text-muted)] uppercase tracking-wide">Callsign</dt>
        <dd class="text-[var(--text-subtitle)] text-[var(--color-text-primary)] font-[var(--font-mono)]">{qso.callsign}</dd>
      </div>
      <div>
        <dt class="text-[var(--text-body)] text-[var(--color-text-muted)] uppercase tracking-wide">Date</dt>
        <dd class="text-[var(--text-body)] text-[var(--color-text-primary)]">{formatDate(qso.time_on)}</dd>
      </div>
      <div>
        <dt class="text-[var(--text-body)] text-[var(--color-text-muted)] uppercase tracking-wide">Time On</dt>
        <dd class="text-[var(--text-body)] text-[var(--color-text-primary)]">{formatTime(qso.time_on)}</dd>
      </div>
      {#if qso.time_off}
        <div>
          <dt class="text-[var(--text-body)] text-[var(--color-text-muted)] uppercase tracking-wide">Time Off</dt>
          <dd class="text-[var(--text-body)] text-[var(--color-text-primary)]">{formatTime(qso.time_off!)}</dd>
        </div>
      {/if}
      <div>
        <dt class="text-[var(--text-body)] text-[var(--color-text-muted)] uppercase tracking-wide">Band</dt>
        <dd class="text-[var(--text-body)] text-[var(--color-text-primary)]">{fmt(qso.band)}</dd>
      </div>
      <div>
        <dt class="text-[var(--text-body)] text-[var(--color-text-muted)] uppercase tracking-wide">Frequency</dt>
        <dd class="text-[var(--text-body)] text-[var(--color-text-primary)]">{qso.freq ? `${qso.freq} MHz` : DASH}</dd>
      </div>
      <div>
        <dt class="text-[var(--text-body)] text-[var(--color-text-muted)] uppercase tracking-wide">Mode</dt>
        <dd class="text-[var(--text-body)] text-[var(--color-text-primary)]">{fmt(qso.mode)}</dd>
      </div>
      <div>
        <dt class="text-[var(--text-body)] text-[var(--color-text-muted)] uppercase tracking-wide">RST Sent</dt>
        <dd class="text-[var(--text-body)] text-[var(--color-text-primary)]">{fmt(qso.rst_sent)}</dd>
      </div>
      <div>
        <dt class="text-[var(--text-body)] text-[var(--color-text-muted)] uppercase tracking-wide">RST Received</dt>
  ...
  <section>
    ...
    <dl class="grid grid-cols-1 md:grid-cols-2 gap-x-[var(--space-8)] gap-y-[var(--space-3)]">
      <div>
        <dt class="text-[var(--text-body)] text-[var(--color-text-muted)] uppercase tracking-wide">QSL Sent</dt>
        <dd class="text-[var(--text-body)] text-[var(--color-text-primary)]">{fmt(qso.qsl_sent)}</dd>
      </div>
      <div>
        <dt class="text-[var(--text-body)] text-[var(--color-text-muted)] uppercase tracking-wide">QSL Sent Via</dt>
        <dd class="text-[var(--text-body)] text-[var(--color-text-primary)]">{fmt(qso.qsl_sent_via)}</dd>
      </div>
      <div>
        <dt class="text-[var(--text-body)] text-[var(--color-text-muted)] uppercase tracking-wide">QSL Received</dt>
        <dd class="text-[var(--text-body)] text-[var(--color-text-primary)]">{fmt(qso.qsl_rcvd)}</dd>
      </div>
      <div>
        <dt class="text-[var(--text-body)] text-[var(--color-text-muted)] uppercase tracking-wide">QSL Received Via</dt>
        <dd class="text-[var(--text-body)] text-[var(--color-text-primary)]">{fmt(qso.qsl_rcvd_via)}</dd>
      </div>
      <div>
        <dt class="text-[var(--text-body)] text-[var(--color-text-muted)] uppercase tracking-wide">LoTW Sent</dt>
        <dd class="text-[var(--text-body)] text-[var(--color-text-primary)]">{fmt(qso.lotw_qsl_sent)}</dd>
      </div>
      <div>
        <dt class="text-[var(--text-body)] text-[var(--color-text-muted)] uppercase tracking-wide">LoTW Received</dt>
        <dd class="text-[var(--text-body)] text-[var(--color-text-primary)]">{fmt(qso.lotw_qsl_rcvd)}</dd>
      </div>
      <div>
        <dt class="text-[var(--text-body)] text-[var(--color-text-muted)] uppercase tracking-wide">eQSL Sent</dt>
        <dd class="text-[var(--text-body)] text-[var(--color-text-primary)]">{fmt(qso.eqsl_qsl_sent)}</dd>
      </div>
      <div>
        <dt class="text-[var(--text-body)] text-[var(--color-text-muted)] uppercase tracking-wide">eQSL Received</dt>
  ...
  <section>
    ...
    <dl class="grid grid-cols-1 md:grid-cols-2 gap-x-[var(--space-8)] gap-y-[var(--space-3)]">
      <div>
        <dt class="text-[var(--text-body)] text-[var(--color-text-muted)] uppercase tracking-wide">Name</dt>
        <dd class="text-[var(--text-body)] text-[var(--color-text-primary)]">{fmt(qso.name)}</dd>
      </div>
      <div>
        <dt class="text-[var(--text-body)] text-[var(--color-text-muted)] uppercase tracking-wide">QTH</dt>
        <dd class="text-[var(--text-body)] text-[var(--color-text-primary)]">{fmt(qso.qth)}</dd>
      </div>
      <div>
        <dt class="text-[var(--text-body)] text-[var(--color-text-muted)] uppercase tracking-wide">Grid Square</dt>
        <dd class="text-[var(--text-body)] text-[var(--color-text-primary)] font-[var(--font-mono)]">{fmt(qso.grid_square)}</dd>
      </div>
      <div>
        <dt class="text-[var(--text-body)] text-[var(--color-text-muted)] uppercase tracking-wide">Power</dt>
        <dd class="text-[var(--text-body)] text-[var(--color-text-primary)]">{qso.tx_pwr ? `${qso.tx_pwr} W` : DASH}</dd>
      </div>
      {#if qso.comment}
        <div class="md:col-span-2">
          <dt class="text-[var(--text-body)] text-[var(--color-text-muted)] uppercase tracking-wide">Comment</dt>
  ...
  <section>
    ...
    <dl class="grid grid-cols-1 md:grid-cols-2 gap-x-[var(--space-8)] gap-y-[var(--space-3)]">
      <div>
        <dt class="text-[var(--text-body)] text-[var(--color-text-muted)] uppercase tracking-wide">Country</dt>
        <dd class="text-[var(--text-body)] text-[var(--color-text-primary)]">{fmt(qso.country)}</dd>
      </div>
      <div>
        <dt class="text-[var(--text-body)] text-[var(--color-text-muted)] uppercase tracking-wide">DXCC</dt>
        <dd class="text-[var(--text-body)] text-[var(--color-text-primary)]">{fmt(qso.dxcc)}</dd>
      </div>
      <div>
        <dt class="text-[var(--text-body)] text-[var(--color-text-muted)] uppercase tracking-wide">CQ Zone</dt>
        <dd class="text-[var(--text-body)] text-[var(--color-text-primary)]">{fmt(qso.cq_zone)}</dd>
      </div>
      <div>
        <dt class="text-[var(--text-body)] text-[var(--color-text-muted)] uppercase tracking-wide">ITU Zone</dt>
        <dd class="text-[var(--text-body)] text-[var(--color-text-primary)]">{fmt(qso.itu_zone)}</dd>
      </div>
      <div>
        <dt class="text-[var(--text-body)] text-[var(--color-text-muted)] uppercase tracking-wide">Continent</dt>
  ...
  <section>
    ...
    <dl class="grid grid-cols-1 md:grid-cols-2 gap-x-[var(--space-8)] gap-y-[var(--space-3)]">
      <div>
        <dt class="text-[var(--text-body)] text-[var(--color-text-muted)] uppercase tracking-wide">Prop Mode</dt>
        <dd class="text-[var(--text-body)] text-[var(--color-text-primary)]">{fmt(qso.prop_mode)}</dd>
      </div>
      <div>
        <dt class="text-[var(--text-body)] text-[var(--color-text-muted)] uppercase tracking-wide">Satellite</dt>
        <dd class="text-[var(--text-body)] text-[var(--color-text-primary)]">{fmt(qso.sat_name)}</dd>
      </div>
      <div>
        <dt class="text-[var(--text-body)] text-[var(--color-text-muted)] uppercase tracking-wide">Submode</dt>
        <dd class="text-[var(--text-body)] text-[var(--color-text-primary)]">{fmt(qso.submode)}</dd>
      </div>
      <div>
        <dt class="text-[var(--text-body)] text-[var(--color-text-muted)] uppercase tracking-wide">Operator</dt>
        <dd class="text-[var(--text-body)] text-[var(--color-text-primary)]">{fmt(qso.operator)}</dd>
      </div>
      <div>
        <dt class="text-[var(--text-body)] text-[var(--color-text-muted)] uppercase tracking-wide">Distance</dt>
      ...
      {#if qso.latitude !== null && qso.latitude !== undefined}
        <div>
          <dt class="text-[var(--text-body)] text-[var(--color-text-muted)] uppercase tracking-wide">Latitude</dt>
      ...
      {#if qso.longitude !== null && qso.longitude !== undefined}
        <div>
          <dt class="text-[var(--text-body)] text-[var(--color-text-muted)] uppercase tracking-wide">Longitude</dt>
  ...
  <section>
    ...
    <dl class="grid grid-cols-1 md:grid-cols-2 gap-x-[var(--space-8)] gap-y-[var(--space-3)]">
      <div>
        <dt class="text-[var(--text-body)] text-[var(--color-text-muted)] uppercase tracking-wide">Created</dt>
        <dd class="text-[var(--text-body)] text-[var(--color-text-secondary)]">{formatTimestamp(qso.created_at)}</dd>
      </div>
      <div>
        <dt class="text-[var(--text-body)] text-[var(--color-text-muted)] uppercase tracking-wide">Updated</dt>
