  ...
  <form onsubmit={handleSubmit} class="flex flex-col gap-6 pb-24 lg:pb-6">
    ...
    <CollapsibleSection title={t.qso.sectionQsl}>
      <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <FormSelect label={t.qso.lotwQslSent} bind:value={optLotwQslSent} options={qslStatusOptions} />
        <FormSelect label={t.qso.lotwQslRcvd} bind:value={optLotwQslRcvd} options={qslStatusOptions} />
        <FormSelect label={t.qso.eqslQslSent} bind:value={optEqslQslSent} options={qslStatusOptions} />
        <FormSelect label={t.qso.eqslQslRcvd} bind:value={optEqslQslRcvd} options={qslStatusOptions} />
      </div>
    </CollapsibleSection>
